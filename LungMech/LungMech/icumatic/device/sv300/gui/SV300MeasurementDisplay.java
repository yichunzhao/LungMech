/*
 * SV300MeasurementDisplay.java
 *
 * Created on 2. november 2004, 17:10
 */
 ...
 * @author  yichun
 */
public class SV300MeasurementDisplay extends javax.swing.JPanel implements Observer{
    
    /** Creates new form SV300MeasurementDisplay */
    public SV300MeasurementDisplay() {
        initComponents();
    }

    public SV300MeasurementDisplay(DataModel dataModel) {
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jTextFieldAirwayFlow.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldInspPress.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldExspPress.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldPeak.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldPeep.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldFreq.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldInspTidal.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldExspTidal.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
        ...
        jTextFieldExspTidal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldExspTidalActionPerformed(evt);
            }
        });
        ...
        jTextFieldUpperPressLimit.setFont(new java.awt.Font("MS Sans Serif", 0, 12));
    ...
    private void jTextFieldExspTidalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldExspTidalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldExspTidalActionPerformed
    ...
    public void update(Observable o, Object arg) {
        ...
        double freq = this.dataModel.getFrequency();
        this.jTextFieldFreq.setText(Double.toString(freq));
